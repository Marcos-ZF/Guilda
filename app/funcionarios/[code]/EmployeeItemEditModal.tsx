...
type Equipment = { id: string; name: string; item_type: string; rarity: "Comum" | "Lendária"; description: string; image_url: string | null; document_url: string | null };
